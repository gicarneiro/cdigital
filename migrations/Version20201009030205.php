...
final class Version20201009030205 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transacao (id INT NOT NULL, origem_id INT NOT NULL, destino_id INT NOT NULL, data TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, valor TYPE numeric(15,2) NOT NULL, PRIMARY KEY(id))');
